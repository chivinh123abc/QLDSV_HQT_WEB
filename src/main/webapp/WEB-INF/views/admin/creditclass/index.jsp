                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.role == 'PGV'}">
                                                    <div class="input-group">
                                                        ...
                                                        <form action="${pageContext.request.contextPath}/admin/creditclass" method="GET" class="d-inline flex-grow-1">
                                                            <select name="maKhoa"
                                                        ...
                                                        <c:if test="${sessionScope.role == 'PGV' || sessionScope.role == 'KHOA'}">
                                                            <td class="text-center">
                                                                <div class="d-flex gap-2 justify-content-center">
                                                                    ...
                                                                    <form action="${pageContext.request.contextPath}/admin/creditclass" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa lớp tín chỉ này không?');" class="d-inline">
                                                                        <input type="hidden" name="csrf_token" value="${csrfToken}" />
                                                                        <input type="hidden" name="maLTC" value="${item.maLTC}">
                                                                        <input type="hidden" name="maKhoa" value="${maKhoa}">
                                                                        <s:message code="credit-class.cannot.delete" var="cannotDeleteMsg" />
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg rounded-4">
                            <div class="modal-header bg-primary text-white border-0 py-3 px-4 rounded-top-4">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/creditclass?maKhoa=${maKhoa}" class="btn-close btn-close-white text-decoration-none"></a>
                            </div>
                            <form action="${pageContext.request.contextPath}/admin/creditclass" method="POST">
                                <input type="hidden" name="csrf_token" value="${csrfToken}" />
                                ...
                                <div class="modal-footer border-0 px-4 pb-4">
                                    <a href="${pageContext.request.contextPath}/admin/creditclass?maKhoa=${maKhoa}" class="btn btn-light rounded-3 fw-bold"><s:message code="global.btn.cancel"/></a>
                                    <c:choose>
