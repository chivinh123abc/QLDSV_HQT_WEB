                                ...
                                <div class="card-body px-4 pb-4">
                                    ...
                                    <div
                                        ...
                                        <div class="input-group" style="max-width: 300px;">
                                            ...
                                            <s:message code="classroom.search" var="lblClassroomSearch"/>
                                            <input type="text" id="search-input"
                                                class="form-control bg-light border-0 small"
                                                placeholder="${lblClassroomSearch}" onkeyup="filterLocal()">
                                        </div>
                                        <div class="d-flex gap-3 align-items-center">
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.role == 'PGV'}">
                                                    <form action="${pageContext.request.contextPath}/admin/classroom" method="GET" class="d-inline">
                                                        <select name="maKhoa"
                                                        ...
                                                        <c:if test="${sessionScope.role == 'PGV'}">
                                                            <td class="text-center">
                                                                <div class="d-flex gap-2 justify-content-center">
                                                                    <!-- Edit Link GET -->
                                                                    <a href="${pageContext.request.contextPath}/admin/classroom?maKhoa=${maKhoa}&maLop=${item.maLop}&lnkEdit" class="btn btn-sm btn-outline-primary border-0 rounded-3">
                                                                        <i class="bi bi-pencil-square"></i>
                                                                    </a>
                                                                    <!-- Delete Form POST -->
                                                                    <form action="${pageContext.request.contextPath}/admin/classroom" method="POST" onsubmit="return confirm('<s:message code="classroom.js.confirmDelete"/>');" class="d-inline">
                                                                        <input type="hidden" name="csrf_token" value="${csrfToken}" />
                                                                        <input type="hidden" name="maLop" value="${item.maLop}">
                                                                        <input type="hidden" name="maKhoa" value="${maKhoa}">
                                                                         <s:message code="classroom.cannot.delete" var="cannotDeleteMsg" />
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg rounded-4">
                        <div class="modal-header bg-primary text-white border-0 py-3 px-4 rounded-top-4">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/classroom?maKhoa=${maKhoa}" class="btn-close btn-close-white text-decoration-none"></a>
                        </div>
                        <form:form action="${pageContext.request.contextPath}/admin/classroom" method="POST" modelAttribute="lop">
                            ...
                            <div class="modal-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <s:message code="classroom.example.desc" var="lblClassroomExampleDesc"/>
                                        <form:input path="tenLop" cssClass="form-control rounded-3"
                                            placeholder="${lblClassroomExampleDesc}"/>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <s:message code="classroom.select.faculty" var="lblSelectFaculty"/>
                            ...
                            <div class="modal-footer border-0 px-4 pb-4">
                                <a href="${pageContext.request.contextPath}/admin/classroom?maKhoa=${maKhoa}" class="btn btn-light rounded-3 fw-bold"><s:message code="global.btn.cancel"/></a>
                                <c:choose>
