            ...
            <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
                <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                    ...
                    <head>
                        ...
                        <title>
                            <s:message code="student.management.title" />
                        </title>
                        <!-- Bootstrap CSS -->
                                    ...
                                    <div class="container-fluid max-w-7xl mx-auto">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-4">
                                            ...
                                            <h3 class="mb-0 fw-bold text-dark">
                                                <s:message code="student.management" />
                                            </h3>
                                        </div>
                                        ...
                                        <c:if test="${not empty errorLines}">
                                            <div class="alert alert-warning alert-dismissible fade show rounded-3 shadow-sm border-0 mb-4"
                                                ...
                                                <h6 class="fw-bold"><i class="bi bi-exclamation-triangle-fill me-2"></i>
                                                    <s:message code="student.import.errorList"
                                                        arguments="${errorLines.size()}" />
                                                </h6>
                                                <ul class="mb-0 small"
                                                    style="max-height: 150px; overflow-y: auto; padding-left: 20px;">
                                        ...
                                        <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                                            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-2">
                                                <h6 class="fw-bold text-primary text-uppercase small mb-0">
                                                    <s:message code="student.management.by.class" />
                                                </h6>
                                            </div>
                                            <div class="card-body px-4 pb-4">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <div class="input-group" style="max-width: 300px;">
                                                        ...
                                                        <s:message code="student.search.class"
                                                            var="lblStudentSearchClass" />
                                                        <input type="text" id="class-search"
                                                            class="form-control bg-light border-0 small"
                                                            placeholder="${lblStudentSearchClass}"
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <c:choose>
                                                            <c:when test="${sessionScope.role == 'PGV'}">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <select name="maKhoa"
                                                                        ...
                                                                        <option value="all">
                                                                            <s:message code="student.all.faculties" />
                                                                        </option>
                                                                        <c:forEach var="khoa" items="${khoaList}">
                                                                            <option value="${khoa.maKhoa}"
                                                                                ${param.maKhoa==khoa.maKhoa ||
                                                                                maKhoa==khoa.maKhoa ? 'selected' : '' }>
                                                                                ${khoa.tenKhoa}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                            ...
                                                            <c:otherwise>
                                                                <div
                                                                    class="d-flex align-items-center gap-2 px-3 py-1 bg-light rounded-pill border">
                                                                    <i class="bi bi-building text-primary small"></i>
                                                                    <span
                                                                        class="fw-bold text-dark small">${khoaList[0].tenKhoa}</span>
                                                                </div>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                    ...
                                                    <table class="table table-hover align-middle mb-0">
                                                        <thead class="table-light">
                                                            <tr>
                                                                <th class="border-0 px-3 small fw-bold text-muted">
                                                                    <s:message code="classroom.lbl.classCode" />
                                                                </th>
                                                                <th class="border-0 small fw-bold text-muted">
                                                                    <s:message code="classroom.lbl.className" />
                                                                </th>
                                                                <th
                                                                    class="border-0 text-center small fw-bold text-muted">
                                                                    <s:message code="classroom.lbl.academicTerm" />
                                                                </th>
                                                                <th
                                                                    class="border-0 text-center small fw-bold text-muted">
                                                                    KHOA</th>
                                                        ...
                                                        <tbody id="class-table-body" class="border-top-0">
                                                            <c:forEach var="lop" items="${lopList}">
                                                                <c:set var="classUrl"
                                                                    value="${pageContext.request.contextPath}/admin/student?maLop=${lop.maLop}" />
                                                            ...
                                                            <c:if test="${empty lopList}">
                                                                <tr>
                                                                    <td colspan="4" class="text-center py-4 text-muted">
                                                                        <s:message code="student.no.classes.found" />
                                                                    </td>
                                                                </tr>
                                                            </c:if>
                                                        </tbody>
                                                ...
                                                <div class="mt-2 text-muted small px-1">
                                                    ...
                                                    <s:message code="student.select.class.hint" />
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                                                        <div
                                                            ...
                                                            <h6
                                                                ...
                                                                Danh sách sinh viên -
                                                                <s:message code="registration.class.label" /> <span
                                                            ...
                                                            <c:if test="${sessionScope.role == 'PGV'}">
                                                                <div class="d-flex gap-2">
                                                                    <!-- Import Button -->
                                                                    <button type="button"
                                                                        class="btn btn-info btn-sm text-white rounded-3 px-3 fw-bold shadow-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#importCsvModal">
                                                                        <i
                                                                            class="bi bi-file-earmark-arrow-up-fill me-1"></i>
                                                                        <s:message code="student.btn.importCsv" />
                                                                    </button>
                                                                    <!-- Export Button -->
                                                                    <a href="${pageContext.request.contextPath}/admin/student/export-credentials?maLop=${maLop}"
                                                                        class="btn btn-success btn-sm rounded-3 px-3 fw-bold shadow-sm">
                                                                        <i
                                                                            class="bi bi-file-earmark-arrow-down-fill me-1"></i>
                                                                        <s:message code="student.btn.exportAccounts" />
                                                                    </a>
                                                                    <!-- Button to trigger ADD modal via query parameter (clean reload) -->
                                                                    <a href="${pageContext.request.contextPath}/admin/student?maLop=${maLop}&lnkAdd"
                                                                        class="btn btn-primary btn-sm rounded-3 px-3 fw-bold shadow-sm">
                                                                        <i class="bi bi-person-plus-fill me-1"></i>
                                                                        <s:message code="student.btn.add" />
                                                                    </a>
                                                                </div>
                                                            </c:if>
                                                        </div>
                                                        <div class="card-body px-4 pb-4">
                                                            <div
                                                                ...
                                                                <div class="input-group" style="max-width: 300px;">
                                                                    <span class="input-group-text bg-light border-0"><i
                                                                            class="bi bi-search text-muted"></i></span>
                                                                    <s:message code="student.search.student"
                                                                        var="lblStudentSearchStudent" />
                                                                    <input type="text" id="student-search"
                                                                        class="form-control bg-light border-0 small"
                                                                        placeholder="${lblStudentSearchStudent}"
                                                            ...
                                                            <div class="table-responsive rounded-3 border">
                                                                <table class="table table-hover align-middle mb-0">
                                                                    <thead class="table-light">
                                                                        <tr>
                                                                            <th
                                                                                class="border-0 px-3 small fw-bold text-muted">
                                                                                <s:message
                                                                                    code="student.lbl.studentId" />
                                                                            </th>
                                                                            <th
                                                                            ...
                                                                            <th
                                                                                class="border-0 text-center small fw-bold text-muted">
                                                                                <s:message
                                                                                    code="student.lbl.gender.upper" />
                                                                            </th>
                                                                            <th
                                                                                class="border-0 text-center small fw-bold text-muted">
                                                                                <s:message
                                                                                    code="student.lbl.dob.upper" />
                                                                            </th>
                                                                            <th
                                                                                class="border-0 small fw-bold text-muted">
                                                                                <s:message code="student.address" />
                                                                            </th>
                                                                            <th
                                                                                class="border-0 text-center small fw-bold text-muted">
                                                                                <s:message
                                                                                    code="credit-class.lbl.status" />
                                                                            </th>
                                                                            <c:if test="${sessionScope.role == 'PGV'}">
                                                                                <th
                                                                                    class="border-0 text-center small fw-bold text-muted">
                                                                                    <s:message
                                                                                        code="global.lbl.actions" />
                                                                                </th>
                                                                            </c:if>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody id="main-student-table-body">
                                                                        <c:forEach var="sv" items="${sinhVienList}">
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-center">
                                                                                    <span
                                                                                        class="badge border ${sv.daNghiHoc ? 'border-danger text-danger' : 'border-success text-success'} rounded-pill px-3 py-1 small fw-bold">
                                                                                        <s:message
                                                                                            code="${sv.daNghiHoc ? 'student.status.suspended' : 'student.status.active'}" />
                                                                                    </span>
                                                                                </td>
                                                                                <c:if
                                                                                    test="${sessionScope.role == 'PGV'}">
                                                                                    <td class="text-center">
                                                                                        <div
                                                                                            class="d-flex gap-2 justify-content-center align-items-center">
                                                                                            <!-- GET link for Edit modal reload -->
                                                                                            <a href="${pageContext.request.contextPath}/admin/student?maLop=${maLop}&maSV=${sv.maSV}&lnkEdit"
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                <button type="submit"
                                                                                                    ...
                                                                                                    ${!sv.canDelete
                                                                                                    ? 'disabled' : '' }
                                                                                                    title="${!sv.canDelete ? cannotDeleteMsg : ''}">
                                                                                                    <i
                                                ...
                                                <c:otherwise>
                                                    <div
                                                        ...
                                                        <h5 class="text-muted fw-bold">
                                                            <s:message code="student.please.select.class" />
                                                        </h5>
                                                        <p class="text-muted small">
                                                            <s:message code="student.info.placeholder" />
                                                        </p>
                                                    </div>
                                                </c:otherwise>
                                            </c:choose>
                            ...
                            <div class="modal fade show d-block" id="studentModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content border-0 shadow-lg rounded-4">
                                        <div
                                            class="modal-header bg-primary text-white border-0 py-3 px-4 rounded-top-4">
                                            <h5 class="modal-title fw-bold d-flex align-items-center gap-2">
                                                <i class="bi bi-person-vcard"></i>
                                                <c:choose>
                                                    <c:when test="${mode == 'edit'}">
                                                        <s:message code="student.update.profile" />
                                                    </c:when>
                                                    <c:otherwise>
                                                        <s:message code="student.add.new" />
                                                    </c:otherwise>
                                                </c:choose>
                                            </h5>
                                            <a href="${pageContext.request.contextPath}/admin/student?maLop=${maLop}"
                                        ...
                                        <%-- Spring Form Taglib: form:form bind modelAttribute="sinhVien" (StudentDTO)
                                            --%>
                                            <form:form action="${pageContext.request.contextPath}/admin/student"
                                                    ...
                                                    <div class="modal-body p-4">
                                                        <div class="row g-3">
                                                            <div class="col-md-4">
                                                                ...
                                                                <%-- form:input tự động điền lại gi├í trß╗ï khi form lß╗ùi
                                                                    ...
                                                                    <form:input path="maSV"
                                                                        cssClass="form-control rounded-3" id="inp_maSV"
                                                                        placeholder="${lblStudentExampleId}"
                                                                        readonly="${mode == 'edit'}" />
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label small fw-bold text-muted">
                                                                    <s:message code="student.lbl.lastName" />
                                                                </label>
                                                                <s:message code="student.example.name"
                                                                    var="lblStudentExampleName" />
                                                                <form:input path="ho" cssClass="form-control rounded-3"
                                                                    id="inp_ho"
                                                                    placeholder="${lblStudentExampleName}" />
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label small fw-bold text-muted">
                                                                    <s:message code="lecturer.lbl.firstName.required" />
                                                                </label>
                                                                <s:message code="student.example.firstName"
                                                                    var="lblStudentExampleFirstName" />
                                                                <form:input path="ten" cssClass="form-control rounded-3"
                                                                    id="inp_ten"
                                                                    placeholder="${lblStudentExampleFirstName}" />
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label small fw-bold text-muted">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <s:message code="student.example.address"
                                                                    var="lblStudentExampleAddress" />
                                                                <form:input path="diaChi"
                                                                    cssClass="form-control rounded-3" id="inp_diaChi"
                                                                    placeholder="${lblStudentExampleAddress}" />
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div
                                                                    class="form-check form-switch p-0 d-flex align-items-center gap-2"> 
                                                                        ...
                                                                        <label
                                                                            ...
                                                                            for="daNghiHoc">
                                                                            <s:message code="student.status.dropped" />
                                                                        </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${mode == 'edit'}">
                                                                <button type="submit" name="btnUpdate"
                                                                    ...
                                                                    <s:message code="global.btn.save.action" /> (
                        ...
                        <div class="modal fade" id="importCsvModal" tabindex="-1" aria-labelledby="importCsvModalLabel"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content border-0 shadow-lg rounded-4">
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/student/import" method="POST"
                                        ...
                                        <div class="modal-body p-4">
                                            ...
                                            <div class="alert alert-info border-0 rounded-3 mb-3 small">
                                                ...
                                                <ul class="ps-3 mb-2" style="list-style-type: disc;">
                                                    <li>
                                                        <s:message code="student.import.guide.headers" /> <strong>MASV,
                                                            HOTEN, GIOITINH, NGAYSINH, EMAIL, MALOP</strong>
                                                    </li>
                                                    <li>
                                                        <s:message code="student.import.guide.separator" />
                                                        <strong>,</strong>
                                                    </li>
                                                    <li>
                                                        <s:message code="student.import.guide.encoding" />
                                                    </li>
                                                    <li>
                                                        <s:message code="student.import.guide.dob" />
                                                    </li>
                                                    <li>
                                                        <s:message code="student.import.guide.gender" />
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <label for="csvFileInput"
                                                        ...
                                                        <s:message code="student.import.file.selectBtn" />
                                                    </label>
                                                ...
                                                <div class="form-text text-muted small mt-1">
                                                    <s:message code="student.import.file.hint" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer border-0 px-4 pb-4">
                                            ...
                                            <button type="submit"
                                                ...
                                                <s:message code="student.import.btn.submit" />
                                            </button>
                                        </div>
                                    </form>
                                </div>
