                                            ...
                                            <table class="table table-custom align-middle mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-center" style="width: 15%;">
                                                            <s:message code="global.lbl.status" />
                                                        </th>
                                                         ...
                                                         <tr data-role="${item.roleId}">
                                                             ...
                                                             <td class="text-center">
                                                                 <c:choose>
                                                                     <c:when test="${item.status == 'CHUA_KICH_HOAT'}">
                                                                         <span class="badge bg-secondary"><s:message code="account.status.inactive"/></span>
                                                                     </c:when>
                                                                     <c:when test="${item.status == 'DA_KICH_HOAT'}">
                                                                         <span class="badge bg-success"><s:message code="account.status.active"/></span>
                                                                     </c:when>
                                                                     <c:when test="${item.status == 'KHOA'}">
                                                                         <span class="badge bg-danger"><s:message code="account.status.locked"/></span>
                                                                     </c:when>
                                                                     <c:otherwise>
                                                             ...
                                                             <td class="text-center">
                                                                 <div class="d-flex gap-2 justify-content-center">
                                                                     <a href="${pageContext.request.contextPath}/admin/account?userId=${item.userId}&lnkEdit"
                                     ...
                                     <div class="modal-body p-4">
                                         <div class="row g-3">
                                             ...
                                             <c:if test="${mode == 'edit'}">
                                                 <div class="col-12">
                                                     <label class="form-label small fw-bold text-muted">
                                                         <s:message code="account.lbl.status"/> <span class="text-danger">*</span>
                                                     </label>
                                                     <select class="form-select rounded-3" name="status" id="inp_status" required>
                                                         <option value="CHUA_KICH_HOAT" ${account.trangThai == 'CHUA_KICH_HOAT' ? 'selected' : ''}><s:message code="account.status.inactive"/></option>
                                                         <option value="DA_KICH_HOAT" ${account.trangThai == 'DA_KICH_HOAT' ? 'selected' : ''}><s:message code="account.status.active"/></option>
                                                         <option value="KHOA" ${account.trangThai == 'KHOA' ? 'selected' : ''}><s:message code="account.status.locked"/></option>
                                                     </select>
                                                 </div>
                                             </c:if>
                                         </div>
