                        ...
                        <div class="container-fluid max-w-7xl mx-auto">
                            ...
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                                <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/faculty?lnkAdd=true" class="btn btn-primary btn-sm rounded-3 px-3 fw-bold shadow-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="d-flex gap-2 justify-content-center">
                                                                <!-- Edit Link GET -->
                                                                <a href="${pageContext.request.contextPath}/admin/faculty?maKhoa=${item.maKhoa}&lnkEdit" class="btn btn-sm btn-outline-primary border-0 rounded-3">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg rounded-4">
                            <div class="modal-header bg-primary text-white border-0 py-3 px-4 rounded-top-4">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/faculty" class="btn-close btn-close-white text-decoration-none"></a>
                            </div>
                            <form action="${pageContext.request.contextPath}/admin/faculty" method="POST">
                                ...
                                <div class="modal-footer border-0 px-4 pb-4">
                                    <a href="${pageContext.request.contextPath}/admin/faculty" class="btn btn-light rounded-3 fw-bold"><s:message code="global.btn.cancel"/></a>
                                    <c:choose>
