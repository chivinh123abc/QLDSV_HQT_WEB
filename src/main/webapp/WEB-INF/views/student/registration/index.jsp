                        ...
                        <div class="col-lg-4">
                            <div class="card border-0 shadow-sm rounded-4 mb-4">
                                <div class="card-body p-4">
                                    <h6 class="fw-bold text-primary mb-3"><s:message code="registration.student.info"/></h6>
                                    ...
                                    <div class="bg-light p-3 rounded-3">
                                        ...
                                        <div class="small text-muted"><i class="bi bi-info-circle me-2"></i>Trạng thái: 
                                            <span class="badge ${selectedStudent.daNghiHoc ? 'bg-danger' : 'bg-success'} bg-opacity-10 ${selectedStudent.daNghiHoc ? 'text-danger' : 'text-success'} rounded-pill">
                                                 <s:message code="${selectedStudent.daNghiHoc ? 'student.status.dropped' : 'student.status.active'}"/>
                                             </span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="list-group list-group-flush">
                                                <c:forEach var="reg" items="${myRegistrations}">
                                                    <div class="list-group-item px-0 py-3 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <form action="${pageContext.request.contextPath}/student/registration" method="POST" onsubmit="return confirm('<s:message code="registration.js.confirmUnregister"/>');">
                                                        ...
                                                        <td class="text-center">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${isSameSubjectRegistered}">
                                                                    <button class="btn btn-sm btn-secondary rounded-3 px-3" disabled title="Đã đăng ký môn học này trong học kỳ">
                                                                ...
                                                                <c:otherwise>
                                                                    <form action="${pageContext.request.contextPath}/student/registration" method="POST">
                                                                        <input type="hidden" name="csrf_token" value="${csrfToken}" />
                                                                        <input type="hidden" name="maLTC" value="${item.maLTC}">
                                                                        <button type="submit" name="btnInsert" class="btn btn-sm btn-primary rounded-3 px-3">
