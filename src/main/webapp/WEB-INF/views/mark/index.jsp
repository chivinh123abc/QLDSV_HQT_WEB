                ...
                <div class="container-fluid max-w-7xl mx-auto">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
                        <div class="animate__animated animate__fadeInLeft">
                            <h2 class="page-title"><i class="bi bi-grid-3x3-gap-fill me-2"></i>Quản lý Nhập điểm</h2>
                            <p class="text-muted small mb-0">Hệ thống nhập điểm học phần theo lớp tín chỉ</p>
                        </div>
                        <div class="d-flex gap-2 animate__animated animate__fadeInRight" id="summaryHeader" style="display: none !important;">
                            <div class="summary-badge"><i class="bi bi-book text-primary"></i> <span id="sum-subject">---</span></div>
                            <div class="summary-badge"><i class="bi bi-people text-success"></i> <span id="sum-count">0</span> SV</div>
                    ...
                    <div class="filter-section animate__animated animate__fadeIn">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-2 col-md-12">
                                ...
                                <input type="text" class="form-control border-0 bg-light rounded-3 shadow-none" id="searchMaSV" placeholder="Nhập mã SV...">
                            </div>
                            <div class="col-lg-1 col-md-4 d-flex align-items-end">
                                <button type="button" class="btn btn-primary w-100 rounded-3 p-2 shadow-sm" id="btnLoad">
