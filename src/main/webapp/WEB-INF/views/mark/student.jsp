...
<body>
                            ...
                            <div id="semesters-container">
                                <c:forEach var="entry" items="${groupedMarks}">
                                    <div class="semester-section mb-5" data-semester-name="${entry.key}">
                                        ...
                                        <!-- Summary Box theo đúng tham chiếu hình -->
    ...
    <script>
        ...
        function calculateDynamicGrades() {
            // Get all semesters, ordered from oldest to newest to compute cumulative values correctly!
            // Note: Since JSTL rendered newest first, we reverse the array of sections to calculate cumulative metrics bottom-up (chronologically)
            ...
            // Set global statistics top tiles (of the newest state)
        ...
        function filterGrades() {
            ...
            sections.forEach(section => {
                ...
                // Hide the whole semester section if it doesn't match selection or has no visible rows matching the search query
