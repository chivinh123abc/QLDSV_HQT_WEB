                            ...
                            <div class="card-body p-4">
                                <div class="text-center border-bottom pb-4 mb-4">
                                    <div class="position-relative d-inline-block mb-3">
                                        ...
                                        <form action="${pageContext.request.contextPath}/profile/update-avatar" method="POST" enctype="multipart/form-data" class="mt-3 mx-auto" style="max-width: 250px;" id="avatarUploadForm">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <c:if test="${not empty studentProfile}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <c:choose>
                                                    <c:when test="${studentProfile.phai == 'NAM'}">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4 bg-light rounded-3 p-3">
                                    ...
                                    <form action="${pageContext.request.contextPath}/profile/send-otp" method="POST">
                                        <input type="hidden" name="csrf_token" value="${csrfToken}" />
