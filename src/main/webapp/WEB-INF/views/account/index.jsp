                                            ...
                                            <tr data-role="${item.roleId}">
                                                ...
                                                <td class="text-center">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${item.roleId == 2}"><span class="badge bg-warning text-dark">KHOA</span></c:when>
                                                        <c:when test="${item.roleId == 3}"><span class="badge bg-success">SINHVIEN</span></c:when>
