package com.ptithcm.modules.admin.creditclass;
...
import com.ptithcm.modules.creditclass.CreditClassService;
...
@Controller
@RequestMapping("/admin/creditclass")
public class AdminCreditClassController {
    ...
    public String index(ModelMap model, @RequestParam(value = "maKhoa", required = false) String maKhoa,
        ...
        return "admin/creditclass/index";
    }
    ...
    public String insert(ModelMap model, @Valid @ModelAttribute("ltc") CreditClassDTO creditClassDto,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/admin/creditclass?maKhoa=" + creditClassDto.getMaKhoa() + "&lnkAdd=true";
        }
        ...
        return "redirect:/admin/creditclass?maKhoa=" + creditClassDto.getMaKhoa();
    }
    ...
    public String update(ModelMap model, @Valid @ModelAttribute("ltc") CreditClassDTO creditClassDto,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/admin/creditclass?maKhoa=" + creditClassDto.getMaKhoa() + "&maLTC="
                    + creditClassDto.getMaLTC() + "&lnkEdit";
        }
        LopTinChi ltc = new LopTinChi();
        try {
            ltc.setMaLTC(creditClassDto.getMaLTC());
    ...
    public String delete(@RequestParam("maLTC") String maLTC, @RequestParam("maKhoa") String maKhoa,
        ...
        return "redirect:/admin/creditclass?maKhoa=" + maKhoa;
    }
