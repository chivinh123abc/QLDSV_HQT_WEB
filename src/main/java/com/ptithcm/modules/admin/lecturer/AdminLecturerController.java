package com.ptithcm.modules.admin.lecturer;
...
import com.ptithcm.modules.lecturer.LecturerService;
...
public class AdminLecturerController {
    ...
    public String insert(ModelMap model, @Valid @ModelAttribute("giangVien") LecturerDTO lecturerDto,
        ...
        return "redirect:/admin/lecturer?maKhoa=" + lecturerDto.getMaKhoa();
    }
    ...
    public String delete(@RequestParam("maGV") String maGV, @RequestParam("maKhoa") String maKhoa,
        ...
        return "redirect:/admin/lecturer?maKhoa=" + maKhoa;
    }
