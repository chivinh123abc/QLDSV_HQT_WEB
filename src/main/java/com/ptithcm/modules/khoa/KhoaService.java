...
public class KhoaService {
    ...
    public List<String> listTrimmedKhoaFromLop() {
        return khoaDAO.listTrimmedKhoaFromLop();
    }

    public List<String> listTrimmedKhoaFromGiangVien() {
        return khoaDAO.listTrimmedKhoaFromGiangVien();
    }

    public List<String> listTrimmedKhoaFromLtc() {
        return khoaDAO.listTrimmedKhoaFromLtc();
    }

    public String saveKhoa(Khoa khoa, String mode) throws Exception {
        Khoa existing = khoaDAO.findById(khoa.getMaKhoa());
        if ("add".equals(mode)) {
            if (existing != null) {
