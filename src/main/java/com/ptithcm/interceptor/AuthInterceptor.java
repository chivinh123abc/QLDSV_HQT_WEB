                            ...
                            if (parts.length == 2 && factory != null) {
                                ...
                                try {
                                    ...
                                    if (user != null) {
                                        ...
                                        if (user.getRoleId() == 1) session.setAttribute("role", "PGV");
                                        else if (user.getRoleId() == 2) session.setAttribute("role", "KHOA");
                                            ...
                                            if (svProfile != null) session.setAttribute("studentProfile", svProfile);
                                        }
                                    }
                                } finally {
                                    hSession.close();
